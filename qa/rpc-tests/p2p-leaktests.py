...
# Copyright (c) 2017-2019 The Mincoin Core developers
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if mincoind ban behavior changes
    def on_open(self, conn):
        super().on_open(conn)
...
class P2PLeakTest(MincoinTestFramework):
    def __init__(self):
        super().__init__()
        self.num_nodes = 1
