...
* Update translations (ping xieta on IRC) see [translation_process.md](https://github.com/mincoin/mincoin/blob/master/doc/translation_process.gmd#synchronising-translations).
...
(or ping @xieta on IRC, he has specific tooling to generate the list of merged pulls
...
Setup Gitian descriptors:
    ...
    pushd ./mincoin
    export SIGNER=(your Gitian key, ie xieta)
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the mincoin.us server
  into `/var/www/bin/mincoin-core-${VERSION}`
...
people without access to `mincoin.us` to download the binary distribution.
