...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    // Check for nMinDiskSpace bytes (currently 1GiB)
...
unsigned char pchMessageStart[4] = { 0x63, 0x42, 0x21, 0x2c }; // Mincoin: switched at 1393657079.
