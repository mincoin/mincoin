...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s mincoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mincoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mincoin transaction") + "\n" +
              "  mincoin-tx [options] -create [commands]   " + _("Create hex-encoded mincoin transaction") + "\n" +
              "\n";
